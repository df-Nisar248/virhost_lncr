...
path('donwloadvirhostdataforReviwer/',TemplateView.as_view(template_name="lncrna/todowload.html"),name="downloading"),
path('donwloadvirhost/', views.donwloadvh, name = 'donwloadvh'),
path('donwloadvirtarget/', views.donwloadtarget, name = 'donwloadtarget'),
]
